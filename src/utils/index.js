...
export const contactsInfo = [
  {
    id:1,
    img: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="39" viewBox="0 0 32 39" fill="none">< path d="M1 15.4C1 29.8 16 37 16 37C16 37 31 29.8 31 15.4C31 7.45 24.2875 1 16 1C7.7125 1 1 7.45 1 15.4Z" stroke="#007E85" stroke- width="2" /><path d="M16.0001 20.32C18.8499 20.32 21.1601 18.0098 21.1601 15.16C21.1601 12.3102 18.8499 10 16.0001 10C13.1503 10 10.8401 12.3102 10.8401 15.16C10.8401 18.0098 13.1503 20.32 16.0001 20.32Z" stroke="#007E85" stroke-width="2" /></svg > ,
    text: 'адрес',
  ...
  },
  {
    ...
    img: <svg xmlns="http://www.w3.org/2000/svg" width="39" height="32" viewBox="0 0 39 32" fill="none">
      <path d="M1.7998 1H37.1998V30.5H1.7998V1Z" stroke="#007E85" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M37.1998 6.8999L19.4998 18.6999L1.7998 6.8999" stroke="#007E85" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>,
    text: 'эл. почта',
  ...
  },
  {
    ...
    img: <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
      ...
      <path d="M21.6777 23.5L16.6777 16V6" stroke="#007E85" stroke-width="2" stroke-linecap="round" />
    </svg>,
    text: 'график работы',
